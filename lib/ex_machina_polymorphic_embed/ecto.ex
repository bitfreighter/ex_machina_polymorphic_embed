if Code.ensure_compiled(ExMachina) == {:module, ExMachina} do
  defmodule ExMachinaPolymorphicEmbed.Ecto do
    @moduledoc """
    `ExMachina.Ecto` replacement that supports `PolymorphicEmbed`.
    """

    # Copied from https://github.com/beam-community/ex_machina/blob/b2f47a36b84fded6c37434bbf9041b33b30387e9/lib/ex_machina/ecto.ex
    defmacro __using__(opts) do
      quote do
        use ExMachina
        use ExMachinaPolymorphicEmbed.EctoStrategy, unquote(opts)
